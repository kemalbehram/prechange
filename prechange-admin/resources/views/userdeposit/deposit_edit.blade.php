		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					...
					<br /><br />
					<form method="post" id="currency_form" action="{{ url('admin/azn_deposit_update') }}" autocomplete="off" onsubmit="btn_update.disabled = true; return true;">
						{{ csrf_field() }}
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<img src="https://bitrota.com/{{ $deposit->proof }}" width="50%" /><i class="form-group__bar"></i><br /><br />
									<a href="https://bitrota.com/{{ $deposit->proof }}" target="_blank">Click to view large</a>
								</div>
							</div>
						</div>
						<div class="row">
