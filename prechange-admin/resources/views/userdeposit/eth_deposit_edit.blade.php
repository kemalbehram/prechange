...
<section class="content">
	<header class="content__title">
		<h1>ETH Deposit History</h1>
	</header>
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					<a href="{{ url('admin/deposits/ETH') }}"><i class="zmdi zmdi-arrow-left"></i> Back to withdraw history</a>
					<br /><br />
					@if(session('status'))
                    ...
                    @endif
				     <form method="post" id="currency_form" action="{{ url('admin/eth_deposit_update') }}" autocomplete="off" onsubmit="btn_update.disabled = true; return true;">
