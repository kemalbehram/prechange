...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					<a href="{{ url('admin/withdraw/XRP') }}"><i class="zmdi zmdi-arrow-left"></i> Back to withdraw history</a>
					<br /><br />
					@if(session('status'))
                    ...
                    @endif
				     <form method="post" id="currency_form" action="{{ url('admin/update_xrpwithdraw') }}" autocomplete="off" onsubmit="btn_update.disabled = true; return true;">
