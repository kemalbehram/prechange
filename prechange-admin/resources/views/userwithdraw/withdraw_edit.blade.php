...
<section class="content">
	<header class="content__title">
		<h1>{{ currency($withdraw->type) }} Withdraw History</h1>
	</header>
	@if(session('status'))
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					<a href="{{ url('admin/withdraw/'.currency($withdraw->type)) }}"><i class="zmdi zmdi-arrow-left"></i> Back to withdraw history</a>
					<br /><br />
				     <form method="post" id="currency_form" action="{{ url('admin/withdraw_update') }}" autocomplete="off" onsubmit="btn_update.disabled = true; return true;">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label>Requested Withdraw Amount ({{ currency($withdraw->type) }})</label>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label>Withdraw Fee ({{ currency($withdraw->type) }})</label>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label>Total Deducted Amount ({{ currency($withdraw->type) }})</label>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<input type="text" name="total_amount" class="form-control" value="{{ $withdraw->total_deducted_amount != NULL ? number_format($withdraw->total_deducted_amount, 2, '.', '') : 'None' }}" readonly /><i class="form-group__bar"></i>
								</div>
							</div>
						</div>
						<div class="row">
