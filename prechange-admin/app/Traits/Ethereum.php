...
{	
	...
	{
		$url = "http://api.etherscan.io/api?module=account&action=txlist&address=".$address."&startblock=0&endblock=99999999&sort=asc&apikey=CCUH3GDDJXE6CGYWU8XK1VAZI652YWIYRS";
	...
	{
		$url = "https://api.etherscan.io/api?module=account&action=tokentx&contractaddress=0x4dfc4a641bcd37a97527c86ffcad43f6000de1a3&address=".$address."&page=1&offset=100&sort=asc&apikey=CCUH3GDDJXE6CGYWU8XK1VAZI652YWIYRS";
	    $balance = $this->exec_cUrls($url);
	    return $balance;
	}
	...
	public function ethSendTransaction($fromaddress, $toaddress, $eth_amount, $pvk)
	{
		...
		curl_setopt($ch, CURLOPT_URL, "http://45.76.25.116:8545");
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
		curl_setopt($ch, CURLOPT_POST, 1);
